...
var renderDOM = function () {
    ...
    if (!toastContainer)
        return;
    render(React__default.createElement(TransitionGroup, { appear: true, className: styles['toast-list'] + " " + styles[defaultOptions.position] }, toastComponentList.map(function (t) { return (React__default.createElement(CSSTransition, { key: t.id, timeout: 300, classNames: "toast" }, t.component)); })), toastContainer);
};
var Toast = function (_a) {
    var message = _a.message, className = _a.className, clickable = _a.clickable, render$$1 = _a.render, onClick = _a.onClick;
    var messageDOM = React.useRef();
    ...
    return (React__default.createElement("div", { ref: messageDOM, className: styles['toast-message'] + " " + className }, render$$1 ? (render$$1(message)) : (React__default.createElement("div", __assign({ className: contentClassNames }, (clickable && clickableProps)), message))));
};
...
function toast(message, timeOrOptions) {
    ...
    toastComponentList.push({
        id: id,
        message: message,
        component: (React__default.createElement(Toast, { message: message, className: className, clickable: clickable || clickClosable, render: render$$1, onClick: handleClick })),
    });
    renderDOM();
